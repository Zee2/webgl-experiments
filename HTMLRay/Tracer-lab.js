	...
	for (var c=0;c<hres;c++)
  	{
        ...
        if (xPoint == null)
        ...
        else
            {
                ...
                glMatrix.vec3.subtract(V,eyePoint,xPoint);
                glMatrix.vec3.subtract(N,xPoint,sphereCenter);
                glMatrix.vec3.subtract(L,lightPosition,xPoint);
